...
public:
	...
	//ObjectClass
	virtual bool				vt_entry_D4(){THISCALL(0x65AA80);}
	...
	//RadioClass
	virtual int					vt_entry_274(DWORD dwUnk){PUSH_VAR32(dwUnk);THISCALL(0x65ACB0);}
	virtual int					vt_entry_278(DWORD dwUnk,DWORD dwUnk2)
								{PUSH_VAR32(dwUnk2);PUSH_VAR32(dwUnk);THISCALL(0x65AAA0);}
	virtual int					vt_entry_27C(DWORD dwUnk,DWORD dwUnk2,DWORD dwUnk3)
								{PUSH_VAR32(dwUnk3);PUSH_VAR32(dwUnk2);PUSH_VAR32(dwUnk);THISCALL(0x65A970);}
