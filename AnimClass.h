...
public:
	...
	virtual HRESULT _stdcall GetClassID(CLSID* pClassID)
		{ PUSH_VAR32(pClassID); PUSH_VAR32(this); CALL_RET(0x426540, HRESULT); }

	//IPersistStream
	virtual HRESULT _stdcall Load(IStream* pStm)
		{ PUSH_VAR32(pStm); PUSH_VAR32(this); CALL_RET(0x425280, HRESULT); }
	virtual HRESULT _stdcall Save(IStream* pStm, BOOL fClearDirty)
		{ PUSH_VAR32(fClearDirty); PUSH_VAR32(pStm); PUSH_VAR32(this); CALL_RET(0x4253B0, HRESULT); }
	...
	virtual CoordStruct* GetCoords(CoordStruct* pCrd)
		{ PUSH_VAR32(pCrd); THISCALL_RET(0x422BE0, CoordStruct*); }
	virtual void Update()
		{ THISCALL(0x423AC0); }

	//ObjectClass
	virtual eLayer InWhichLayer()
		{ THISCALL_RET(0x424CB0, eLayer); }
	virtual ObjectTypeClass* GetType()
		{ return Type; }
	virtual int vt_entry_B8()
		{ THISCALL_RET(0x422BC0, int); }
	virtual bool vt_entry_D4()
		{ THISCALL_RET(0x425530, bool); }
	...
	virtual bool vt_entry_104(DWORD dwUnk, DWORD dwUnk2, DWORD dwUnk3)
		{ PUSH_VAR32(dwUnk3); PUSH_VAR32(dwUnk2); PUSH_VAR32(dwUnk); THISCALL_RET(0x422C70, bool); }
	virtual DWORD vt_entry_108(DWORD dwUnk)
		{ PUSH_VAR32(dwUnk); THISCALL_RET(0x4238D0, DWORD); }
	...
	virtual bool SetLayer(eLayer nValue)
		{ PUSH_VAR32(nValue); THISCALL_RET(0x4238B0, bool); }
	virtual int GetZ()
		{ THISCALL_RET(0x425630, int); }

	//AnimClass
	virtual void AnimExtras()
		{ };
	virtual int GetEnd()
		{ return Type->get_End(); } //End tag from the AnimType
